...
# Model running on simualted data
if (FALSE) {
  ...
  parser$add_argument("-d", "--data_name", default = 'Cortex2-10xChromium-100hvg', help = "Simulation data name.")
  ...
  metric_save_path <- "./res/logs/evaluation/simulation/"
  pred_save_path <- "./res/prediction/simulation/"
  ...
  # saveRDS(model_conf_mat, sprintf("%s/%s-%s%s-sign_conf_mats.rds", pred_save_path, data_name, simulation_name, need_preprocess_str))
}
