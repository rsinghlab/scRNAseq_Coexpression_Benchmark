# Description: Util functions for benchmarks.
...
suppressPackageStartupMessages({
  ...
  library(minet)
  library(ZILGM)
  # Source codes of scDesign2 are available at https://github.com/JSB-UCLA/scDesign2
  files.sources <- list.files("./Benchmark/scDesign2_src/R/", full.names = TRUE)
