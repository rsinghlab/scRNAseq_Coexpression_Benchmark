...
def compareModelMetricsOnscLink(metric_dir_path, data_name):
    print("=" * 70)
    ...
    visBox4Metric(raw_F1_vis, all_models_list, title=data_name, metric_name="F1 score")
    # Compare TPR and FPR
    ...
    visTprFpr(raw_tpr_fpr_vis, all_models_list, title=data_name)



if __name__ == '__main__':
    # metric_dir_path = "../res/logs/evaluation/scLink_simulation/"
    # compareModelMetricsOnscLink(metric_dir_path, data_name="50hvg-scLink")
    # compareModelMetricsOnscLink(metric_dir_path, data_name="100hvg-scLink")
    # # -----
    metric_dir_path = "../res/logs/evaluation/ZILGM_simulation/"
    compareModelMetricsOnscLink(metric_dir_path, data_name="50hvg-ZILGM")
    compareModelMetricsOnscLink(metric_dir_path, data_name="100hvg-ZILGM")
