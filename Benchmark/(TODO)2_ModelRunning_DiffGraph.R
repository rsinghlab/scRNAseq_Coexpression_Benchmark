...
if (TRUE) {
  ...
  parser$add_argument("-d", "--data_name", default = 'Cortex1-10xChromium-100hvg-GRN', help = "scRNA-seq data name.")
  ...
  data_filename <- sprintf("./data/diff_graph/%s-NORTA-data_mat.csv", data_name)
