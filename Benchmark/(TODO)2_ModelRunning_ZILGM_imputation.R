...
if (TRUE) {
  ...
  parser$add_argument("-m", "--simulation_model", default = 'NORTA-ALRA', help = "Simulation method,NORTA or netSmooth.")
  # parser$add_argument("-d", "--data_name", default = 'Cortex1-10xChromium-50hvg', help = "Simulation data name.")
  # parser$add_argument("-d", "--data_name", default = 'Cortex2-Smart_seq2-50hvg', help = "Simulation data name.")
  # parser$add_argument("-d", "--data_name", default = 'pbmc2-Drop-50hvg', help = "Simulation data name.")
  parser$add_argument("-d", "--data_name", default = 'pbmc1-inDrops-50hvg', help = "Simulation data name.")
  ...
  metric_save_path <- "./res/logs/evaluation/ZILGM_model_imputation/"
  pred_save_path <- "./res/prediction/ZILGM_model_imputation/"
...
if (FALSE) {
  ...
  # Parameters
  parser <- ArgumentParser()
  parser$add_argument("-d", "--data_name", default = '100gene-9groups-1-MAGIC', help = "Simulation data name.")
  ...
  # Save data
  # a <- apply(all_model_metrics, 2, as.character)
  metric_save_path <- "./res/logs/evaluation/ZILGM_model_SERGIO_imputation/"
  pred_save_path <- "./res/prediction/ZILGM_model_SERGIO_imputation/"
  need_preprocess_str <- ifelse(need_preprocess, "-process", "")
