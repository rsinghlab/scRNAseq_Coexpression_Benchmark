...
if (FALSE) {
  ...
  parser$add_argument("-d", "--data_name", default = '100gene-hub-0.9sparsity', help = "scRNA-seq data name.")
  ...
  data_filename <- sprintf("./data/diff_sparsity/%s-NORTA-data_mat.csv", data_name)
