...
sys.path.append("/")
sys.path.append("../")
from dca_io import read_dataset, normalize
from train import train
from network import AE_types

# from Models.dca.dca_io import read_dataset, normalize
# from Models.dca.train import train
# from Models.dca.network import AE_types
